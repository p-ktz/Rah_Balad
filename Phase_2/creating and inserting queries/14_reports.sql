...
INSERT INTO rah_balad.reports (
  ...
  (9, '3434343434', 2, 'Rejected', 'تخفیف اعمال نشد', 'دو بار تخفیف خواستم اعمال کنم نشد.', 'طبق قوانین فقط یک تخفیف مجاز است.'),
  ...
  (20, '3434343434', 1, 'Pending', 'عدم تطابق زمان', 'ساعت اعلام‌شده با حرکت واقعی تفاوت داشت.', NULL);
